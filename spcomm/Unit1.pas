...
begin
     ...
     begin
          ...
          MyIniFile.WriteString('AUTOSEND', 'SEND1', TESEND01.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND2', TESEND02.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND3', TESEND03.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND4', TESEND04.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND5', TESEND05.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND6', TESEND06.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND7', TESEND07.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND8', TESEND08.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND9', TESEND09.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND10', TESEND10.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND11', TESEND11.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND12', TESEND12.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND13', TESEND13.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND14', TESEND14.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND15', TESEND15.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND16', TESEND16.Text);

          MyIniFile.WriteString('AUTOSEND', 'SEND17', TESEND17.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND18', TESEND18.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND19', TESEND19.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND20', TESEND20.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND21', TESEND21.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND22', TESEND22.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND23', TESEND23.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND24', TESEND24.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND25', TESEND25.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND26', TESEND26.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND27', TESEND27.Text);

          MyIniFile.WriteString('AUTOSEND', 'SEND28', TESEND28.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND29', TESEND29.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND30', TESEND30.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND31', TESEND31.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND32', TESEND32.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND33', TESEND33.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND34', TESEND34.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND35', TESEND35.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND36', TESEND36.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND37', TESEND37.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND38', TESEND38.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND39', TESEND39.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND40', TESEND40.Text);
          MyIniFile.WriteString('AUTOSEND', 'SEND41', TESEND41.Text);
     ...
     begin
          ...
          TESEND01.Text := MyIniFile.ReadString('AUTOSEND', 'SEND1', '');
          TESEND02.Text := MyIniFile.ReadString('AUTOSEND', 'SEND2',  '');
          TESEND03.Text := MyIniFile.ReadString('AUTOSEND', 'SEND3',  '');
          TESEND04.Text := MyIniFile.ReadString('AUTOSEND', 'SEND4',  '');
          TESEND05.Text := MyIniFile.ReadString('AUTOSEND', 'SEND5',  '');
          TESEND06.Text := MyIniFile.ReadString('AUTOSEND', 'SEND6',  '');
          TESEND07.Text := MyIniFile.ReadString('AUTOSEND', 'SEND7',  '');
          TESEND08.Text := MyIniFile.ReadString('AUTOSEND', 'SEND8',  '');
          TESEND09.Text := MyIniFile.ReadString('AUTOSEND', 'SEND9',  '');
          TESEND10.Text := MyIniFile.ReadString('AUTOSEND', 'SEND10',  '');
          TESEND11.Text := MyIniFile.ReadString('AUTOSEND', 'SEND11',  '');
          TESEND12.Text := MyIniFile.ReadString('AUTOSEND', 'SEND12',  '');
          TESEND13.Text := MyIniFile.ReadString('AUTOSEND', 'SEND13',  '');
          TESEND14.Text := MyIniFile.ReadString('AUTOSEND', 'SEND14',  '');
          TESEND15.Text := MyIniFile.ReadString('AUTOSEND', 'SEND15',  '');
          TESEND16.Text := MyIniFile.ReadString('AUTOSEND', 'SEND16',  '');

          TESEND17.Text := MyIniFile.ReadString('AUTOSEND', 'SEND17', '');
          TESEND18.Text := MyIniFile.ReadString('AUTOSEND', 'SEND18', '');
          TESEND19.Text := MyIniFile.ReadString('AUTOSEND', 'SEND19', '');
          TESEND20.Text := MyIniFile.ReadString('AUTOSEND', 'SEND20', '');
          TESEND21.Text := MyIniFile.ReadString('AUTOSEND', 'SEND21', '');
          TESEND22.Text := MyIniFile.ReadString('AUTOSEND', 'SEND22', '');
          TESEND23.Text := MyIniFile.ReadString('AUTOSEND', 'SEND23', '');
          TESEND24.Text := MyIniFile.ReadString('AUTOSEND', 'SEND24', '');
          TESEND25.Text := MyIniFile.ReadString('AUTOSEND', 'SEND25', '');
          TESEND26.Text := MyIniFile.ReadString('AUTOSEND', 'SEND26', '');
          TESEND27.Text := MyIniFile.ReadString('AUTOSEND', 'SEND27', '');

          TESEND28.Text := MyIniFile.ReadString('AUTOSEND', 'SEND28', '');
          TESEND29.Text := MyIniFile.ReadString('AUTOSEND', 'SEND29', '');
          TESEND30.Text := MyIniFile.ReadString('AUTOSEND', 'SEND30', '');
          TESEND31.Text := MyIniFile.ReadString('AUTOSEND', 'SEND31', '');
          TESEND32.Text := MyIniFile.ReadString('AUTOSEND', 'SEND32', '');
          TESEND33.Text := MyIniFile.ReadString('AUTOSEND', 'SEND33', '');
          TESEND34.Text := MyIniFile.ReadString('AUTOSEND', 'SEND34', '');
          TESEND35.Text := MyIniFile.ReadString('AUTOSEND', 'SEND35', '');
          TESEND36.Text := MyIniFile.ReadString('AUTOSEND', 'SEND36', '');
          TESEND37.Text := MyIniFile.ReadString('AUTOSEND', 'SEND37', '');
          TESEND38.Text := MyIniFile.ReadString('AUTOSEND', 'SEND38', '');
          TESEND39.Text := MyIniFile.ReadString('AUTOSEND', 'SEND39', '');
          TESEND40.Text := MyIniFile.ReadString('AUTOSEND', 'SEND40', '');
          TESEND41.Text := MyIniFile.ReadString('AUTOSEND', 'SEND41', '');
...
begin
    ...
    if TESEND01.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND1', TESEND01.Text);
    if TESEND02.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND2', TESEND02.Text);
    if TESEND03.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND3', TESEND03.Text);
    if TESEND04.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND4', TESEND04.Text);
    if TESEND05.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND5', TESEND05.Text);
    if TESEND06.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND6', TESEND06.Text);
    if TESEND07.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND7', TESEND07.Text);
    if TESEND08.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND8', TESEND08.Text);
    if TESEND09.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND9', TESEND09.Text);

    if TESEND10.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND10', TESEND10.Text);
    if TESEND11.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND11', TESEND11.Text);
    if TESEND12.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND12', TESEND12.Text);
    if TESEND13.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND13', TESEND13.Text);
    if TESEND14.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND14', TESEND14.Text);
    if TESEND15.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND15', TESEND15.Text);
    if TESEND16.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND16', TESEND16.Text);
    if TESEND17.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND17', TESEND17.Text);
    if TESEND18.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND18', TESEND18.Text);
    if TESEND19.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND19', TESEND19.Text);

    if TESEND20.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND20', TESEND20.Text);
    if TESEND21.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND21', TESEND21.Text);
    if TESEND22.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND22', TESEND22.Text);
    if TESEND23.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND23', TESEND23.Text);
    if TESEND24.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND24', TESEND24.Text);
    if TESEND25.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND25', TESEND25.Text);
    if TESEND26.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND26', TESEND26.Text);
    if TESEND27.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND27', TESEND27.Text);
    if TESEND28.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND28', TESEND28.Text);
    if TESEND29.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND29', TESEND29.Text);

    if TESEND30.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND30', TESEND30.Text);
    if TESEND31.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND31', TESEND31.Text);
    if TESEND32.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND32', TESEND32.Text);
    if TESEND33.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND33', TESEND33.Text);
    if TESEND34.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND34', TESEND34.Text);
    if TESEND35.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND35', TESEND35.Text);
    if TESEND36.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND36', TESEND36.Text);
    if TESEND37.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND37', TESEND37.Text);
    if TESEND38.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND38', TESEND38.Text);
    if TESEND39.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND39', TESEND39.Text);
    if TESEND40.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND40', TESEND40.Text);
    if TESEND41.Text <> '' then
        MyIniFile.WriteString('AUTOSEND', 'SEND41', TESEND41.Text);
